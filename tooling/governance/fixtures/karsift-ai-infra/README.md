# Pinned karsift-ai-infra contract fixtures (VOC-080-T05, VOC-097-T03, VOC-102-T00, VOC-104, VOC-106, VOC-108, VOC-115, VOC-117, VOC-121, VOC-122, VOC-123, VOC-126, VOC-129, VOC-131)
...
VOC-097-, VOC-102-, VOC-104-, VOC-106-, VOC-108-, VOC-115-, VOC-121-, VOC-122-, VOC-123-, VOC-126-, VOC-129-, or VOC-131-related infra contracts change and
...
byte-for-byte copies from that merge's reviewed tree. VOC-131-T00 advances it
to infrastructure PR #165 merge
`8ce2b77a09a729e458a9f4cbea1ca26eb114d398`; the mirrored source files are
byte-for-byte copies of `.github/workflows/release.yml` and
`tests/test_release_policy.py` from that merge. Both `identify` and `converge`
restore shared lifecycle policy after `Checkout caller release state` and
before `task-completion-runner.py`, using `job.workflow_repository`,
`job.workflow_sha`, `path: karsift-ai-infra`, and
