...
## Fixture pin audit (caller `tooling/governance/fixtures/karsift-ai-infra`)

`PINNED_SHA.txt` records the exact reviewed merge consumed by this mirror.
Historical merge SHAs below remain preserved as audit evidence even when a later
pin advances.

- VOC-115 final shared source merge: `c5d8bccfa8676bd367b53ad5f6f9a51a40c99405`
- VOC-117 role bindings source merge: `37b06aa95030e235b7311b3c14ee23977f62ac76`
