...
export function validateMockInventory() {
  ...
  // VOC-1423 prevents feedback reports from crossing learner ownership
  // boundaries without rewriting retained report history.
  const allowedMigrationFiles = new Set([
    ...
    "20260908210000_voc1423_feedback_report_owner.sql",
  ]);
