...
export function validateMockInventory() {
  ...
  // VOC-1444 rejects whitespace-only persisted auth identity and token-routing
  // identifiers without rewriting retained records.
  const allowedMigrationFiles = new Set([
    ...
    "20260908290000_voc1444_auth_record_identifiers_nonblank.sql",
  ]);
