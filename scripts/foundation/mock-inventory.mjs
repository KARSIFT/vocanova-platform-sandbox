...
export function validateMockInventory() {
  ...
  // account-deletion de-identification flow. Issue #1410 adds the documented
  // immutable-review provenance domains as a forward-only migration.
  const allowedMigrationFiles = new Set([
    ...
    "20260908040000_review_attempt_provenance_enums.sql",
  ]);
