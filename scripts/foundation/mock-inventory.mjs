...
export function validateMockInventory() {
  ...
  // VOC-1437 protects audit history while retaining the transaction-scoped
  // account-deletion de-identification path.
  const allowedMigrationFiles = new Set([
    ...
    "20260908260000_voc1437_feature_audit_immutability.sql",
  ]);
