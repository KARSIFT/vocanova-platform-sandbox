...
export function validateMockInventory() {
  ...
  // VOC-1418 adds paired whitespace-only learner-sentence constraints without
  // rewriting retained learner content.
  const allowedMigrationFiles = new Set([
    ...
    "20260908030000_voc1418_learner_sentence_nonblank.sql",
  ]);
