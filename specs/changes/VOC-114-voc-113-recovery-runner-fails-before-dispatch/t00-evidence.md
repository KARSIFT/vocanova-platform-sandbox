...
merged as source PRs #137 through #145. PRs #137–#142 culminated in
...
at immutable merge `6999e2beda5bbf00028fae04ca0e65324fc59afa`. Independent
caller review then found the project template had inverted D07's job-scoped
Statuses permission. Source PR #145 corrected that template and added scoped
negative assertions at immutable merge
`c5d8bccfa8676bd367b53ad5f6f9a51a40c99405`. The caller fixture and
`PINNED_SHA.txt` advance to that final source merge.
...
# karsift-ai-infra PR #145, head 73a63d42345ff54619d257e4857fc4166a2785af
python3 -m unittest discover -s tests
  → Ran 265 tests — OK
actionlint; shellcheck; YAML parse; policy tests; git diff --check
  → all passed before merge c5d8bccfa8676bd367b53ad5f6f9a51a40c99405
...
`https://github.com/KARSIFT/karsift-ai-infra/pull/145`. The authoritative final
source revision and caller fixture pin are both
`c5d8bccfa8676bd367b53ad5f6f9a51a40c99405`. The additional source/caller PR
