...
workspace root, without rewriting VOC-112 evidence. It does not introduce new
...
- VOC-112 capture fixtures remain the published `develop` bytes and are not
  recaptured onto an implementation head.
...
- `VOC-131-R00`: **High correctness risk** if the caller pin remains
  `863fc1f…` while live `release.yml@main` is already #165. Local suites would
  then assert a stale restore-less fixture. Mitigation: `VOC-131-D02`,
  `VOC-131-AC-00`.
- `VOC-131-R01`: **High release-safety risk** if `identify` restores shared
  policy but `converge` does not, repeating the latent defect that skipped
  promotion in run `33066533397`. Mitigation: `VOC-131-D03`, `VOC-131-AC-02`.
- `VOC-131-R02`: **High correctness risk** if restore uses a mutable ref
  ...
  caller ref. Mitigation: `VOC-131-D03`, `VOC-131-TEST-04`.
- `VOC-131-R03`: **High data-loss risk** if pinning #165 accidentally drops
  #164 unique-develop fail-closed sync or missing-`develop` recovery.
  Mitigation: `VOC-131-D04`, `VOC-131-AC-03`.
- `VOC-131-R04`: **High delivery risk** if this package snapshots the current
  develop/main gap (`karsift-ai-infra#15`), reuses PR #1051, or re-implements
  VOC-129 / VOC-130. Mitigation: `VOC-131-D01`, `VOC-131-D08`,
  `VOC-131-AC-06`.
- `VOC-131-R05`: **High correctness / review-safety risk** if the
  implementation retargets VOC-112 evidence again, repeating the VOC-130
  ...
  `VOC-131-D10`, `VOC-131-AC-05`, `VOC-131-TEST-08`.
- `VOC-131-R06`: **Medium coverage risk** if caller tests advance the pin but
  do not assert restore-before-helper ordering. Mitigation: `VOC-131-D05`,
  `VOC-131-TEST-02`, `VOC-131-TEST-03`.
- `VOC-131-R07`: **Low application-runtime release risk** because ordinary
...
- Protected surfaces: caller `tooling/governance/` fixtures and tests,
  possibly live `.github/workflows/*` if `VOC-131-DEP-07` proves a caller
  dispatch file must change, current-state fixture README, and this package
  directory. VOC-112 evidence fixtures are protected against change.
- `VOC-131-DEP-00` through `VOC-131-DEP-08`: see `change.yaml`.
- `VOC-131-EV-00`: T00 evidence — pin SHA, restore coverage, VOC-112
  identity, preserved #164 contracts, validation commands, and VOC-129 /
  VOC-130 / VOC-131 promotion handoff.
